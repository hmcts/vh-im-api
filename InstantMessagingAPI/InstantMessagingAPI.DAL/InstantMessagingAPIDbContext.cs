...
namespace InstantMessagingAPI.DAL
{
    public class InstantMessagingAPIDbContext : DbContext
    {
        public DbSet<InstantMessage> InstantMessages { get; set; }

        public InstantMessagingAPIDbContext(DbContextOptions options) : base(options)
        {
